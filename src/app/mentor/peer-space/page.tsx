  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-20">
      <div className="page-header">
        <div>
          <h1 className="text-3xl font-black text-gray-900 tracking-tight">Mentor Peer Space</h1>
        ...
        <div className="lg:col-span-8 space-y-8">
          <section className="card p-8 bg-emerald-900 text-white overflow-hidden relative">
             ...
             <div className="relative z-10">
               <h2 className="text-xl font-black mb-2">Mentor Peer Chat</h2>
               ...
               <button className="bg-white text-emerald-900 px-6 py-3 rounded-2xl font-bold flex items-center gap-2 hover:bg-emerald-50 transition-all shadow-xl">
          ...
          <section className="space-y-4">
             ...
             <div className="space-y-3">
               {[
                 ...
                 <div key={i} className="card p-5 hover:bg-gray-50 transition-colors cursor-pointer group">
                ...
                {[
                  ...
                  <div key={i} className="p-4 flex items-center justify-between hover:bg-gray-50 transition-colors cursor-pointer">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-bold text-gray-900">{res.n}</p>
                        <p className="text-[9px] text-gray-400 font-bold uppercase tracking-wider">{res.s}</p>
                      </div>
                    </div>
                    <button className="text-[10px] font-black text-emerald-700 uppercase tracking-widest">Download</button>
                  </div>
                ))}
             </div>
           </section>

           <section className="card p-6 bg-teal-50 border-teal-100">
