  ...
  return (
    <div className="min-h-screen bg-white selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <section className="relative pt-32 pb-24 md:pt-48 md:pb-40 overflow-hidden">
        {/* Background Elements */}
        <AfricanPattern variant="geometric" color="teal" className="opacity-30" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <ScrollReveal direction="up">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-100 text-emerald-800 text-[10px] md:text-xs font-black uppercase tracking-[0.2em]">
            ...
            <ScrollReveal direction="up" delay={400}>
              <p className="text-lg md:text-2xl text-gray-500 font-medium leading-relaxed max-w-2xl mx-auto">
      ...
      <section className="py-24 md:py-32 bg-gray-900 text-white rounded-[3rem] md:rounded-[5rem] mx-4 my-8">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <BentoGrid cols={2}>
            <BentoItem colSpan={1}>
              <GlassCard blur="lg" opacity="light" className="h-full p-8 md:p-12 rounded-[2.5rem] group hover:bg-white/10 transition-all duration-500">
                ...
                <h3 className="text-2xl font-black mb-4 tracking-tight group-hover:text-emerald-950 transition-colors">Discover & Shape</h3>
                <p className="text-emerald-100/50 group-hover:text-emerald-900 font-medium leading-relaxed transition-colors">Identifying emerging talent and providing leadership formation to lead with responsible influence.</p>
              </GlassCard>
            </BentoItem>
            <BentoItem colSpan={1}>
              <GlassCard blur="lg" opacity="light" className="h-full p-8 md:p-12 rounded-[2.5rem] group hover:bg-white/10 transition-all duration-500">
                ...
                <h3 className="text-2xl font-black mb-4 tracking-tight group-hover:text-emerald-950 transition-colors">Curate Narratives</h3>
                <p className="text-emerald-100/50 group-hover:text-emerald-900 font-medium leading-relaxed transition-colors">Producing purpose-driven media that shapes what youth consume across campuses.</p>
              </GlassCard>
            </BentoItem>
            <BentoItem colSpan={1}>
              <GlassCard blur="lg" opacity="light" className="h-full p-8 md:p-12 rounded-[2.5rem] group hover:bg-white/10 transition-all duration-500">
                ...
                <h3 className="text-2xl font-black mb-4 tracking-tight group-hover:text-emerald-950 transition-colors">Host Dialogue</h3>
                <p className="text-emerald-100/50 group-hover:text-emerald-900 font-medium leading-relaxed transition-colors">Creating spaces for intellectual exchange through talks, podcasts, and summits.</p>
              </GlassCard>
            </BentoItem>
            <BentoItem colSpan={1}>
              <GlassCard blur="lg" opacity="light" className="h-full p-8 md:p-12 rounded-[2.5rem] group hover:bg-white/10 transition-all duration-500">
                ...
                <h3 className="text-2xl font-black mb-4 tracking-tight group-hover:text-emerald-950 transition-colors">Produce Insight</h3>
                <p className="text-emerald-100/50 group-hover:text-emerald-900 font-medium leading-relaxed transition-colors">Converting conversations into societal impact through youth-led research and insights.</p>
              </GlassCard>
            </BentoItem>
          </BentoGrid>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-32">
            <div className="flex-1 space-y-12">
              ...
              <div className="grid grid-cols-1 gap-10">
                {[
                  { title: 'Intentional Storytelling', desc: 'Podcasts and documentaries designed to elevate substance and perspective.', icon: <GrowthIcon /> },
                  { title: 'Structured Mentorship', desc: 'Selective cohorts focusing on character, clarity of purpose, and leadership.', icon: <MentorshipIcon /> },
                  { title: 'Insightful Research', desc: 'Evidence-based insights that direct content and policy influence.', icon: <LearningIcon /> },
                ].map((tool) => (
              ...
              <div className="bg-white rounded-[3rem] p-8 md:p-16 shadow-2xl relative overflow-hidden group">
                ...
                <div className="relative z-10 space-y-10">
                  <p className="text-xl md:text-2xl text-gray-600 font-medium leading-relaxed">
                    Africa has the youngest population on earth — more than <span className="text-emerald-700 font-bold"><AnimatedNumber end={400} duration={2} suffix=" million" /></span> people between 15 and 35. By 2050, that number will exceed <span className="text-emerald-700 font-bold"><AnimatedNumber end={830} duration={2} suffix=" million" /></span>. This is either the greatest resource in human history, or the greatest unmanaged risk — depending entirely on what happens to those young people during their formation years.
                  </p>
        ...
        <div className="max-w-7xl mx-auto">
          <ScrollReveal direction="up">
            <div className="text-center mb-12">
              <h2 className="text-xs font-black text-emerald-600 uppercase tracking-[0.3em] mb-4">Voices from the Movement</h2>
              <p className="text-3xl md:text-4xl font-black text-gray-900 tracking-tight">What Our Community Says</p>
            </div>
          </ScrollReveal>
          <TestimonialCarousel
            testimonials={[
              {
                name: 'Sarah A.',
                role: 'Cohort 2024, University of Lagos',
                quote: 'The mentorship program transformed how I approach leadership. I now lead with purpose and clarity.',
              },
              {
                name: 'David M.',
                role: 'Mentor, Cohort 2023',
                quote: 'Watching these students grow into confident leaders has been the most rewarding experience of my career.',
              },
              {
                name: 'Amara K.',
                role: 'Cohort 2024, University of Ghana',
                quote: 'MUI Forge gave me the tools and community I needed to actually make an impact on my campus.',
              },
            ]}
          />
        </div>
